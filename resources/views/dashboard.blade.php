...
<head>
    ...
    <title>{{ config('app.name', 'Toko Roti') }} - Dashboard</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <section class="hero-bg text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl md:text-4xl font-bold mb-2 fade-in">Dashboard {{ auth()->user()->isAdmin() ? 'Admin' : 'Pelanggan' }}</h1>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 dashboard-card">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Rp {{ number_format(\App\Models\Order::sum('total'), 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 dashboard-card">
                        ...
                        <div class="space-y-3">
                            @foreach(\App\Models\Order::with('user')->latest()->limit(5)->get() as $order)
                                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                    <div>
                                        <p class="font-medium text-gray-800">#{{ $order->order_number }} - {{ $order->user->name }}</p>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200 text-center">
                            <a href="{{ route('admin.orders.index') }}" class="text-indigo-600 hover:text-indigo-800 font-medium">Lihat Semua Pesanan →</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 dashboard-card">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200 text-center">
                            <a href="{{ route('products.index') }}" class="text-indigo-600 hover:text-indigo-800 font-medium">Lihat Semua Produk →</a>
                        </div>
                    </div>
                </div>
            @else
                ...
                <div class="bg-white rounded-lg shadow-md p-8 text-center dashboard-card">
                    ...
                    <p class="text-gray-600 mb-8 max-w-2xl mx-auto">Dari dashboard ini Anda dapat mengelola pesanan Anda dan mulai belanja produk-produk terbaik kami.</p>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        <a href="{{ route('orders.index') }}" class="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-bold py-4 px-6 rounded-lg transition-all duration-200 transform hover:-translate-y-1">
                            <div class="text-3xl mb-2">📦</div>
                            <div>Lihat Pesanan Saya</div>
                        </a>
                        <a href="{{ route('home') }}" class="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-4 px-6 rounded-lg transition-all duration-200 transform hover:-translate-y-1">
                            <div class="text-3xl mb-2">🛒</div>
